...
namespace GameFrameX.ShareSdk.Runtime
{
    ...
    /// 分享事件
    /// </summary>
    public sealed class ShareEventArgs : GameEventArgs
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public static ShareEventArgs Create(ResponseState state, PlatformType type, Hashtable data)
        {
            var eventArgs = ReferencePool.Acquire<ShareEventArgs>();
