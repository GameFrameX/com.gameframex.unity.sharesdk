...
namespace GameFrameX.ShareSdk.Runtime
{
    ...
    /// 显示用户信息事件
    /// </summary>
    public sealed class ShowUserEventArgs : GameEventArgs
    {
        /// <summary>
        /// 显示用户信息事件编号
        /// </summary>
        public static readonly string EventId = typeof(ShowUserEventArgs).FullName;
        ...
        /// <returns>显示用户信息事件参数实例</returns>
        public static ShowUserEventArgs Create(ResponseState state, PlatformType type, Hashtable data)
        {
            var eventArgs = ReferencePool.Acquire<ShowUserEventArgs>();
